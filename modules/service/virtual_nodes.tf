...
# resource "aws_appmesh_virtual_node" "blue-prod" {

#   name      = format("%s-%s-blue", var.cluster_name-prod, var.service_name)
#   mesh_name = var.cluster_mesh-prod

#   spec {
#     backend {
#       virtual_service {
#         virtual_service_name = format("%s-%s.local", var.cluster_name-prod, var.service_name)
#       }
#     }
...
#         }
#         service_name   = "blue"
#         namespace_name = format("%s-%s", var.cluster_name-prod, var.service_name)
#       }
#     }
#   }
# }
...
# resource "aws_appmesh_virtual_node" "green-prod" {

#   name      = format("%s-%s-green", var.cluster_name-prod, var.service_name)
#   mesh_name = var.cluster_mesh-prod
